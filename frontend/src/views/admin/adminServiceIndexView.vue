...
export default {
    ...
    methods: {
        ...
        async fetchCategories () {
            await fetch(config.backend + "service/" + this.$route.params.id + "?image=1", {
                method: "POST",
                credentials: "include",
            }).then((response) => {
        ...
        async sendData() {
            ...
            await fetch (config.backend + "service/" + this.$route.params.id + "/edit", {
                method: "POST",
                credentials: "include",
                body: formData,
            }).then((response) => {
                ...
                this.$router.push("/admin/services/" + response.id);
            });
        },
        addimg (ev) {
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <input v-model="overview" type="text">
                        </div>
                        <div>
